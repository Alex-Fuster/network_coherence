...
covariance_types <- c("strong_negative","weak_negative","weak_mixed", "weak_positive", "strong_positive", "strong_mixed")
...
df$cov_type <- factor(df$cov_type, 
                      levels = c("strong_negative", "weak_negative", "weak_mixed", 
                                 "weak_positive", "strong_positive", "strong_mixed"))

# Define the color palette for the scenarios
color_palette <- c("weak_negative" = brewer_pal(palette = "RdBu", direction = -1)(10)[8],  # Weak red
                   "strong_negative" = brewer_pal(palette = "RdBu", direction = -1)(10)[9], # Strong red
                   "weak_positive" = brewer_pal(palette = "RdBu", direction = 1)(10)[8],    # Weak blue
                   "strong_positive" = brewer_pal(palette = "RdBu", direction = 1)(10)[9],  # Strong blue
