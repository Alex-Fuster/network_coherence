...
In this document, we demonstrate how the effects of network coherence on community response to a perturbation was simulated (so far).
...
We first need to set some parameters of the simulation. For this example, we will simlulate a predator-prey network of 10 species.
