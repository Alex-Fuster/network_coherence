...
The correlation between beta-diversity of networks and coherence would depend on modularity and nestedness.

* $\beta_{s} (species turnover) would be highly and inversely correlated to coherence, as highly coherent communities would tend to have similar responses to the environment, and, therefore, species would tend to "move" together. Low coherence in modular and nested networks would mean high species turnover, and species would be replaced as environmental conditions change.

* $\beta_{os} (links turnover) would be higher in less modular and more nested networks, where coherence is high. That's because this measure is related to the number of similar species in any two communities: given that species A, B and C occur in any two networks, if the links between them are different, we have a high $\beta_{os}.

* $\beta_{wn} (network uniqueness) would be higher in highly modular networks where niche overlap is low. Coherence would he higher within each community than in the metaweb.
...
![](e_supporting_material/supporting_figures/coherence_mod_nest.jpg)

-   Niche breath - low and high extremes would decrease coherence, but
    moderate values would increase it.

![](e_supporting_material/supporting_figures/coherence_niche_breadth.jpg)
...
-   Predators would have more periods of incoherence with any pair of preys if they are generalists.

-    Preys would have higher periods of incoherence between them, due to niche partitioning.
:::
